...
models = [
    ...
    #donzo
    {
    "model": Pipeline(steps=[("scaler", scaler), ("model", LogisticRegression(n_jobs=-1, class_weight="balanced"))]) ,
    "params": {
    ...
    {
    "model": ImbPipeline(steps=[("rus", rus), ("scaler", scaler), ("model", MLPClassifier())]) ,
    "params": {
