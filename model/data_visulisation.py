...
tsne_dataframe = pd.DataFrame(
    tsne_components, columns=["tSNE1", "tSNE2", "tSNE3"], index=id_list
)
...
fig_tsne.show()
fig_tsne.write_html(
    OUTPUT_FOLDER + f"tsne2d_perp_{PERPLEXITY}_points_{DATA_POINTS_TO_VISUALISE}.html"
)
...
fig_tsne_3d.write_html(
    OUTPUT_FOLDER + f"tsne3d_perp_{PERPLEXITY}_points_{DATA_POINTS_TO_VISUALISE}.html"
)
